...
<body style="background-color: #141414;">
    <?php
        ...
        $sql = "select * from paymentInfo where email = '$email'";
    ...
    <div class="container-fluid" id="formbox" style="margin-top: 150px;">
        <form class="container needs-validation" action="paymentmodifyProc.php" method="post">
            <div class="continer-fluid px-1">
                <h3 id="maintitle"><strong>결제정보수정</strong></h3>
            ...
            <div class="mb-3 row" id="spec">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control-plaintext" value="<?=$email?>" name="email" readonly>
                </div>
            </div>
            <div class="mb-3 row" id="spec">
            ...
            <div class="mb-3 row" id="spec">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="inputName" value="<?=$row['name']?>" placeholder="홍길동" name="name" data-bs-toggle="tooltip" data-bs-placement="bottom" title="카드 소유자의 이름이에요!">
                </div>
            </div>
            <div class="mb-3 row" id="spec">
                <label for="inputDate" class="col-sm-3 col-form-label">생년월일</label>
                <div class="col-sm-9">
                    <input type="date" class="form-control" value="<?=$row['dateOfBirth']?>" id="inputDate" name="dateOfBirth">
                </div>
            </div>
            <div class="d-grid gap-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="누르면 수정 완료!">
                <button class="btn btn-primary" type="submit">결제정보저장</button>
            </div>
        </form>
    </div>
    <script> // 툴팁을 이쁘게 불러오기 위한 툴팁초기화 자바스크립트
